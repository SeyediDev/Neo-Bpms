...
internal static class ItemDefinitionXmlConvertor
{
    ...
    {
        if (structureDefinition.entityField != null)
            return $"teta:EntityField.{structureDefinition.structure?.NamespaceId}.{structureDefinition.structure?.Id}.{structureDefinition.entityField.Id}";
