...
", true)]//ORDER BY rq.start_time ASC
public class RunTimeQueries
{
    ...
    public string SqlLoginUser;
    public string DurationInSeconds;
    public DateTime start_time;
    public TimeSpan cpu_time; //todo
    public long logical_reads;
    public long writes;
    public string ParentStatement;
    public string query_plan;
    public string wait_type;
    public string BlockingSessionId;
    public string BlockingHostname;
    public string BlockingProgram;
    public string BlockingClientProcessId;
    public string BlockingSql;
}
