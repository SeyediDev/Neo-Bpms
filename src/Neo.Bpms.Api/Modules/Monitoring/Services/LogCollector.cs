...
public class MonitoringLogger : ILogger
{
    ...
    private static Models.LogLevel ConvertLogLevel(Microsoft.Extensions.Logging.LogLevel level)
    {
        return level switch
        {
            Microsoft.Extensions.Logging.LogLevel.Trace => Models.LogLevel.Trace,
            Microsoft.Extensions.Logging.LogLevel.Debug => Models.LogLevel.Debug,
            Microsoft.Extensions.Logging.LogLevel.Information => Models.LogLevel.Information,
