...
public class MonitoringSerilogSink : ILogEventSink
{
    ...
    private static Models.LogLevel ConvertLogLevel(LogEventLevel level)
    {
        return level switch
        {
            LogEventLevel.Verbose => Models.LogLevel.Trace,
            LogEventLevel.Debug => Models.LogLevel.Debug,
            LogEventLevel.Information => Models.LogLevel.Information,
            LogEventLevel.Warning => Models.LogLevel.Warning,
            LogEventLevel.Error => Models.LogLevel.Error,
            LogEventLevel.Fatal => Models.LogLevel.Critical,
