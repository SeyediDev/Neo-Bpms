 ...
 */
!function(n,t){if(void 0===t)return console.error("jQuery required for Ladda.jQuery");var i=[];t=t.extend(t,{ladda:function(t){"stopAll"===t&&n.stopAll()}});t.fn=t.extend(t.fn,{ladda:function(r){var u=i.slice.call(arguments,1);return"bind"===r?(u.unshift(t(this).selector),n.bind.apply(n,u)):t(this).each(function(){var i,f=t(this);void 0===r?f.data("ladda",n.create(this)):(i=f.data("ladda"),i[r].apply(i,u))}),this}})}(this.Ladda,this.jQuery);PaginationManager=function(){var n=function(){var n=$("#jtpInput").val();$('input[name="Page"]').val(n);$("input[name='newPage']").val("0");$("#filter-form").submit()},t=function(n){var t=$(n).find("span").attr("page")?+$(n).find("span").attr("page"):+$(n).find("span").text();$("input[name='newPage']").val("0");$("input[name='Page']").val(t);$("input[name='Page']").closest("form").submit()};return{jumpToPage:n,pageChanged:t}}();$("#showFilter").on("click",function(n){$("#filterDiv").slideToggle();n.stopPropagation()});$(function(){$(".dropdown-menu input").click(function(n){n.stopPropagation()})});
/**
* @license MIT, GPL, do whatever you want
* @requires polyfill: Array.prototype.slice fix {@link https://gist.github.com/brettz9/6093105}
*/
Array.from||(Array.from=function(n){"use strict";return[].slice.call(n)});
/*!
 * 
 * persian-date -  1.1.0
