...
{
    // Valid cultures
    private static readonly List<string> ValidCultures =
    [
        "af",
        "af-ZA",
        "sq",
    ...
    private static readonly List<string> Cultures =
    [
        "fa",
        "en-US"
    ];
    ...
    {
        return ProjectDefinition.Project?.DefaultCulture ?? Cultures[0]; // return Default culture
    }
