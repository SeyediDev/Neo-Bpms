...
using Neo.Bpms.Domain.Entities.Dmn.DecisionTable;
...
/// </summary>
public class DMNExpression(string id, IEnumerable<InformationItem> inputVariable, ItemDefinition itemDefinition) : DMNElement(id)
{
    /// <summary>
