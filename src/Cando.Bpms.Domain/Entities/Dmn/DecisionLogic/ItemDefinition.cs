...
/// </summary>
public class ItemDefinition : DMNElement
{
    /// <summary>
    ...
    /// </summary>
    public List<ItemDefinition> itemComponentRef = null;
    public void addItemComponent(ItemDefinition itemComponentRef)
    {
    ...
    public ItemDefinition(string id, string name, string typeDefinition)
        : base(id, name)
    {
        isCollection = false;
    ...
    public ItemDefinition(string id, string name, string typeRef, bool isCollection) : base(id, name)
    {
    ...
    public ItemDefinition(string id, string name, IEnumerable<ItemDefinition> itemComponentRef)
        : base(id, name)
    {
        isCollection = false;
        typeRef = null;
