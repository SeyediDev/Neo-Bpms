...
{
    private readonly Dictionary<string, ElasticObject> _attributes = [];
    private readonly Dictionary<string, List<ElasticObject>> _elements = [];
    ...
    {
        return name != null && _attributes.ContainsKey(name);
    }
    ...
    public List<ElasticObject> ElementList(string name)
    {
        _elements.TryGetValue(name, out List<ElasticObject> elements);
        return elements;
    }
    ...
    public Dictionary<string, List<ElasticObject>> ElementCollections { get { return _elements; } }

    public IEnumerable<ElasticObject> Elements
    {
        get
        {
            IEnumerable<ElasticObject> result = from list in _elements
    ...
    public void AddElement(ElasticObject element)
    {
        ...
        {
            _elements[element.InternalName] = [];
        }
