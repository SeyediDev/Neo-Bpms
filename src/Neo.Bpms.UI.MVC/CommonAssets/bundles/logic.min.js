 ...
 */
(function(n){n.fn.areYouSure=function(t){var i=n.extend({message:"You have unsaved changes!",dirtyClass:"dirty",change:null,silent:!1,addRemoveFieldsMarksDirty:!1,fieldEvents:"change keyup propertychange input",fieldSelector:":input:not(input[type=submit]):not(input[type=button])",verbose:!1},t),f=function(t){if(t.hasClass("ays-ignore")||t.hasClass("aysIgnore")||t.attr("data-ays-ignore")||t.attr("name")===undefined)return null;if(t.is(":disabled"))return"ays-disabled";var i,r=t.attr("type");t.is("select")&&(r="select");switch(r){case"checkbox":case"radio":i=t.is(":checked");break;case"select":i="";t.find("option").each(function(){var t=n(this);t.is(":selected")&&(i+=t.val())});break;default:i=t.val()}return i},e=function(n){n.data("ays-orig",f(n))},u=function(t){var o=function(n){var t=n.data("ays-orig"),r;return undefined===t?!1:(r=f(n),i.verbose&&console.log(t,r,n),r!=t)},u=n(this).is("form")?n(this):n(this).parents("form"),s,e;if(o(n(t.target))){r(u,!0);return}if($fields=u.find(i.fieldSelector),i.addRemoveFieldsMarksDirty&&(s=u.data("ays-orig-field-count"),s!=$fields.length)){r(u,!0);return}e=!1;$fields.each(function(){return $field=n(this),o($field)?(e=!0,!1):void 0});r(u,e)},o=function(t){var f=t.find(i.fieldSelector);n(f).each(function(){e(n(this))});n(f).unbind(i.fieldEvents,u);n(f).bind(i.fieldEvents,u);t.data("ays-orig-field-count",n(f).length);r(t,!1)},r=function(n,t){var r=t!=n.hasClass(i.dirtyClass);n.toggleClass(i.dirtyClass,t);r&&(i.change&&i.change.call(n,n),t&&n.trigger("dirty.areYouSure",[n]),t||n.trigger("clean.areYouSure",[n]),n.trigger("change.areYouSure",[n]))},s=function(){var t=n(this),r=t.find(i.fieldSelector);n(r).each(function(){var t=n(this);t.data("ays-orig")||(e(t),t.bind(i.fieldEvents,u))});t.trigger("checkform.areYouSure")},h=function(){o(n(this))},c=function(){var t=!1;return n('table[editable="editable"]').each(function(i,r){var u=n(r);if(Number(u.data("original-count"))!==u.find("tbody tr").length-1){t=!0;return}}),t};return i.silent||window.aysUnloadSet||(window.aysUnloadSet=!0,n(window).bind("beforeunload",function(){if(!window.submitCalled&&(window.goBackCalled&&setTimeout(function(){setTimeout(function(){window.HistoryManager&&window.HistoryManager.revertBack()},1e3)},1),c()||n("form").filter("."+i.dirtyClass).length!==0)){if(navigator.userAgent.toLowerCase().match(/msie|chrome/)){if(window.aysHasPrompted)return;window.aysHasPrompted=!0;window.setTimeout(function(){window.aysHasPrompted=!1},900)}return i.message}})),this.each(function(){if(n(this).is("form")){var t=n(this);t.submit(function(){t.removeClass(i.dirtyClass)});t.bind("reset",function(){r(t,!1)});t.bind("rescan.areYouSure",s);t.bind("reinitialize.areYouSure",h);t.bind("checkform.areYouSure",u);o(t)}})}})(jQuery);
/*!
 ...
 * Date:    19th May 2014
 */
$(function(){navigator.userAgent.toLowerCase().match(/iphone|ipad|ipod|opera/)&&$("a").bind("click",function(n){var i=$(n.target).closest("a").attr("href"),t,r;if(i!==undefined&&!(i.match(/^#/)||i.trim()==""))return(t=$(window).triggerHandler("beforeunload",t),t&&t!=""&&(r=t+"\n\nPress OK to leave this page or Cancel to stay.",!confirm(r)))?!1:(window.location.href=i,!1)})});var FormStateManager=function(n,t){var i=function(n){return t.getPageCode()+n},r=function(n){var t=localStorage.getItem(i(n));return t===null?{}:JSON.parse(t)},u=function(n,t,u){var f=r(n);f[t]=u;localStorage.setItem(i(n),JSON.stringify(f))},f=function(){var i,t,f;n('a[data-toggle="tab"]').click(function(t){t.preventDefault();n(this).tab("show")});n('a[data-toggle="tab"]').on("shown.bs.tab",function(t){var i=n(t.target).attr("href");u("selectedTab",n(t.target).closest(".neo-control").data("id"),i)});i=r("selectedTab");for(t in i)i.hasOwnProperty(t)&&(f=(t==="null"?"":'[data-id="'+t+'"] ')+'a[data-toggle="tab"][href="'+i[t]+'"]',n(f).tab("show"))};f()}(window.jQuery,window.PageAddressManager);
/**
 ...
 */
!function(n){function i(i,u){this.element=i;this.options=n.extend({},r,u);this._defaults=r;this._name=t;this.init()}var t="addClear",r;i.prototype={init:function(){var i=n(this.element),r=this,t=this.options;i.wrap("<div class='add-clear-span has-feedback "+t.wrapperClass+"'><\/div>");i.after(n("<span class='add-clear-x form-control-feedback "+t.symbolClass+"' style='display: none;'>"+t.closeSymbol+"<\/span>"));i.next().css({color:t.color,cursor:"pointer","text-decoration":"none",display:"none",overflow:"hidden",position:"absolute","pointer-events":"auto",right:t.right,top:t.top,"z-index":t.zindex},this);i.val().length>=1&&t.showOnLoad===!0&&i.siblings(".add-clear-x").show();i.on("focus.addclear",function(){n(this).val().length>=1&&n(this).siblings(".add-clear-x").show()});i.on("blur.addclear",function(){var i=this;t.hideOnBlur&&setTimeout(function(){n(i).siblings(".add-clear-x").hide()},50)});i.on("keyup.addclear",function(i){t.clearOnEscape===!0&&27==i.keyCode&&(n(this).val("").focus(),t.onClear&&t.onClear(n(this).siblings("input")));n(this).val().length>=1?n(this).siblings(".add-clear-x").show():n(this).siblings(".add-clear-x").hide()});i.on("input.addclear change.addclear paste.addclear",function(){n(this).val().length>=1?n(this).siblings(".add-clear-x").show():n(this).siblings(".add-clear-x").hide()});i.siblings(".add-clear-x").on("click.addclear",function(i){n(this).siblings(r.element).val("");n(this).hide();t.returnFocus===!0&&n(this).siblings(r.element).focus();t.onClear&&t.onClear(n(this).siblings("input"));i.preventDefault()})}};n.fn[t]=function(r,u,f){return this.each(function(){var o,s,e;if("option"===r&&(o=n(this),"show"===u?o.siblings(".add-clear-x").show():"hide"===u&&o.siblings(".add-clear-x").hide()),s=u&&"show"!==u&&"hide"!==u,s){if(e=n.data(this,"plugin_"+t),!e||!e.options)throw"Cannot set option, plugin was not instantiated";e.options[u]=f}else n.data(this,"plugin_"+t)||n.data(this,"plugin_"+t,new i(this,r))})};n.fn[t].Constructor=i;r=n.fn[t].defaults={closeSymbol:"",symbolClass:"glyphicon glyphicon-remove-circle",color:"#CCC",top:0,right:0,returnFocus:!0,showOnLoad:!1,onClear:null,hideOnBlur:!1,clearOnEscape:!0,wrapperClass:"",zindex:100}}(jQuery,window,document);