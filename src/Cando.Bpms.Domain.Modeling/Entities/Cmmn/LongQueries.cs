...
[View(@"SELECT 
    ...
    WHERE epa.attribute = 'dbid'
        AND epa.value = db_id()
", true)]//ORDER BY [AverageElapsedTime] DESC; --Other column aliases can be used
public class LongQueries
{
    public string DatabaseName;
    public long ExecutionCount;
    public double CpuPerExecution;
    public long TotalCPU;
    public double IOPerExecution;
    public long TotalIO;
    public TimeSpan AverageElapsedTime;//todo 
    public TimeSpan AverageTimeBlocked;//todo 
    public double AverageRowsReturned;
