...
namespace Neo.Bpms.Domain.Models.Dmn.DecisionTable;
...
public class Clause
{
    ...
    /// </summary>
    public DMNItemDefinition outputDefinition;
    public string name;
    /// <summary>
    ...
    public Clause(DMNExpression inputExpression, IEnumerable<DMNExpression> inputEntry, DMNItemDefinition outputDefinition)
    {
    ...
    public Clause(string name, IEnumerable<DMNExpression> outputEntry, DMNItemDefinition outputDefinition)
    {
