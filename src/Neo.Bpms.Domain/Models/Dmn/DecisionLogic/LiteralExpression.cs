...
public class LiteralExpression : DMNExpression
{
    ...
    /// </summary>
    public DmnImport import;
    public LiteralExpression(string id, IEnumerable<InformationItem> inputVariable, DMNItemDefinition itemDefinition, string text)
        : base(id, inputVariable, itemDefinition)
    {
        this.text = text;
        import = null;
    }
    public LiteralExpression(string id, IEnumerable<InformationItem> inputVariable, DMNItemDefinition itemDefinition, DmnImport import)
        : base(id, inputVariable, itemDefinition)
    {
        text = null;
        this.import = import;
