...
public partial class Form : BaseModelClass, IEntityPage, IEntityItem
{
    ...
    public TriggerTypeId TriggerTypeId(bool isApply)
    {
        ...
        {
            eFormType.Create => Models.Base.Audit.TriggerTypeId.CreateForm,
            eFormType.Index or eFormType.Edit or eFormType.BulkEdit => Models.Base.Audit.TriggerTypeId.EditForm,
            eFormType.Delete or eFormType.VirtualDelete => Models.Base.Audit.TriggerTypeId.DeleteForm,
            eFormType.ProcessCreate or eFormType.ProcessCreateOnExistingRecord => isApply
                                    ? Models.Base.Audit.TriggerTypeId.CreateAndCompleteTaskByUser
                                    : Models.Base.Audit.TriggerTypeId.CreateInstanceByUser,
            eFormType.WorkItem or eFormType.ActiveProcessInstance or eFormType.ProcessInstance => isApply ? Models.Base.Audit.TriggerTypeId.CompleteTaskByUser : Models.Base.Audit.TriggerTypeId.EditTaskByUser,
            _ => Models.Base.Audit.TriggerTypeId.EditForm,
        };
    }
