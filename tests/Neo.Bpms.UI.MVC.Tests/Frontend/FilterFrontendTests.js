...
describe('Filter Frontend Tests', () => {
    ...
    beforeEach(() => {
        ...
        global.window = {
            submitReportFilter: jest.fn(),
            submitFilter: jest.fn(),
            clearReportFilter: jest.fn(),
            ensureFilterFormAssociation: jest.fn(),
    ...
    describe('FilterParametersManager', () => {
        test('setParameter should update filter parameter input', () => {
            // Arrange
            document.body.innerHTML += `
        ...
        test('setParameter should disable input for IsNull parameter', () => {
            // Arrange
            document.body.innerHTML += `
                <input name="field1" />
                <input name="field1__FilterParameter" />
